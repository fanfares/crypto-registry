...
function CardsSection() {
  return (
    <div className={styles.cardsContainer}>
      ...
      <p className="text-light">Why Excalibur</p>
      <div className={styles.cards}>
        {Cards.map((card, index) => {
          return (
            <div key={index} className={styles.card}>
              <div key={index}>
                <div className={styles.cardImageContainer}>{card.image}</div>
                <div className={styles.cardInfTitle}>
                  <h3 className="text-light">{card.title}</h3>
